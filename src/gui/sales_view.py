...
class SalesView(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.total_label = ttk.Label(totals_frame, text="Total: LKR 0.00", font=("Arial", 14, "bold"))
    ...
    def refresh_products_list(self):
        ...
        for p in products:
            self.products_tree.insert("", "end", values=(p['product_id'], p['name'], f"LKR {p['selling_price']:.2f}"))
    ...
    def add_to_cart(self):
        ...
        price = float(price_str.replace("LKR ", ""))
    ...
    def update_cart_display(self):
        ...
        for item in self.cart:
            ...
            total += item_total
            self.cart_tree.insert("", "end", values=(item['product_id'], item['name'], item['quantity'], f"LKR {item_total:.2f}"))
